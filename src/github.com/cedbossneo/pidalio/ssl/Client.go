...
func CreateServerCertificate(rootCerts RootCerts, ip string) ([]byte, []byte, []byte, error) {
	...
	certificate.AddExtension(openssl.NID_subject_alt_name, "DNS:kubernetes, DNS:kubernetes.default, DNS:kubernetes.default.svc, DNS:kubernetes.default.svc." + os.Getenv("DOMAIN") + ", IP:10.32.0.1, IP:"+ip)
